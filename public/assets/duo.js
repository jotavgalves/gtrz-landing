(()=>{
  const FALLBACK={lot:1,price:50,duoEnabled:true,duoDiscountPerTicket:10,wa:'https://wa.me/5581920013249',sympla:'https://www.sympla.com.br/evento/la-rumba-jampa/3534032'};
  ...
  function render(config){
    ...
    host.innerHTML=`
      <article class="ticket-card ticket-card--single">
        <div class="ticket-card__top"><span class="ticket-card__type">${c.individual}</span></div>
        ...
        <div class="ticket-card__actions">
          <a class="btn btn-primary" href="${individualHref}" target="_blank" rel="noopener">${c.singleBuy}</a>
          <a class="btn btn-secondary" href="${sympla}" target="_blank" rel="noopener">${c.sympla}</a>
        </div>
      </article>
      ${duoEnabled?`<article class="ticket-card ticket-card--duo">
        <div class="ticket-card__top"><span class="ticket-card__type">${c.duoType}</span><span class="ticket-card__badge">${c.best}</span></div>
        ...
        <div class="ticket-card__actions"><a class="btn btn-primary" href="${duoHref}" target="_blank" rel="noopener">${c.duoBuy}</a></div>
